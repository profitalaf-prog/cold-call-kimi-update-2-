...
async function searchOpenStreetMap(niche){const radius=parseInt($('radiusSelect').value,10);setSearching(true);clearAlert();const osmTagMap={'restaurant':['amenity=restaurant','amenity=fast_food'],'restaurants':['amenity=restaurant','amenity=fast_food'],'fast food':['amenity=fast_food'],'cafe':['amenity=cafe'],'cafes':['amenity=cafe'],'bar':['amenity=bar','amenity=pub'],'bars':['amenity=bar','amenity=pub'],'pub':['amenity=pub'],'biergarten':['amenity=biergarten'],'ice cream':['amenity=ice_cream'],'hotel':['tourism=hotel','tourism=motel'],'hotels':['tourism=hotel','tourism=motel'],'motel':['tourism=motel'],'hostel':['tourism=hostel'],'hostels':['tourism=hostel'],'guest house':['tourism=guest_house'],'bed and breakfast':['tourism=guest_house'],'bnb':['tourism=guest_house'],'campsite':['tourism=camp_site'],'camping':['tourism=camp_site'],'dentist':['amenity=dentist'],'dentists':['amenity=dentist'],'doctor':['amenity=doctors'],'doctors':['amenity=doctors'],'clinic':['amenity=clinic'],'clinics':['amenity=clinic'],'hospital':['amenity=hospital'],'pharmacy':['amenity=pharmacy'],'pharmacies':['amenity=pharmacy'],'veterinary':['amenity=veterinary'],'vet':['amenity=veterinary'],'nursing home':['amenity=social_facility','social_facility=nursing_home'],'social facility':['amenity=social_facility'],'hair':['shop=hairdresser'],'hairdresser':['shop=hairdresser'],'hair salon':['shop=hairdresser'],'salon':['shop=hairdresser','shop=beauty'],'beauty':['shop=beauty'],'nail salon':['shop=beauty','beauty=nails'],'tanning':['shop=beauty','beauty=tanning'],'spa':['leisure=spa'],'sauna':['leisure=sauna'],'massage':['shop=massage'],'yoga':['leisure=yoga','sport=yoga'],'gym':['leisure=fitness_centre','leisure=sports_centre'],'gyms':['leisure=fitness_centre','leisure=sports_centre'],'fitness':['leisure=fitness_centre'],'sports centre':['leisure=sports_centre'],'swimming pool':['leisure=swimming_pool'],'pool':['leisure=swimming_pool'],'bowling':['leisure=bowling_alley'],'skating':['leisure=ice_rink'],'ice rink':['leisure=ice_rink'],'golf course':['leisure=golf_course'],'mini golf':['leisure=miniature_golf'],'stadium':['leisure=stadium'],'stadiums':['leisure=stadium'],'dance':['leisure=dance','amenity=dancing_school'],'martial arts':['sport=martial_arts','leisure=sports_centre'],'climbing':['sport=climbing','leisure=sports_centre'],'tennis':['sport=tennis','leisure=sports_centre'],'plumber':['craft=plumber'],'plumbers':['craft=plumber'],'electrician':['craft=electrician'],'electricians':['craft=electrician'],'roofer':['craft=roofer'],'roofers':['craft=roofer'],'carpenter':['craft=carpenter'],'carpenters':['craft=carpenter'],'painter':['craft=painter'],'locksmith':['craft=locksmith','shop=locksmith'],'cleaning':['shop=cleaning'],'gardening':['shop=garden_centre'],'landscaping':['craft=landscaper'],'moving':['shop=moving'],'hvac':['craft=hvac'],'pest control':['shop=pest_control'],'handyman':['craft=handyman'],'mechanic':['shop=car_repair'],'mechanics':['shop=car_repair'],'car repair':['shop=car_repair'],'car wash':['amenity=car_wash'],'fuel':['amenity=fuel'],'gas':['amenity=fuel'],'gas station':['amenity=fuel'],'charging station':['amenity=charging_station'],'car rental':['amenity=car_rental'],'car sharing':['amenity=car_sharing'],'tyres':['shop=tyres'],'motorcycle':['shop=motorcycle'],'truck':['shop=truck'],'lawyer':['office=lawyer'],'lawyers':['office=lawyer'],'attorney':['office=lawyer'],'attorneys':['office=lawyer'],'accountant':['office=accountant'],'accountants':['office=accountant'],'real estate':['office=estate_agent'],'realtor':['office=estate_agent'],'realtors':['office=estate_agent'],'estate agent':['office=estate_agent'],'insurance':['office=insurance'],'bank':['amenity=bank'],'banks':['amenity=bank'],'notary':['office=notary'],'architect':['office=architect'],'consulting':['office=consulting'],'marketing':['office=advertising_agency','office=marketing'],'supermarket':['shop=supermarket'],'supermarkets':['shop=supermarket'],'bakery':['shop=bakery'],'bakeries':['shop=bakery'],'butcher':['shop=butcher'],'butchers':['shop=butcher'],'florist':['shop=florist'],'florists':['shop=florist'],'optician':['shop=optician'],'opticians':['shop=optician'],'shoe':['shop=shoes'],'shoes':['shop=shoes'],'clothing':['shop=clothes'],'clothes':['shop=clothes'],'pet':['shop=pet'],'pets':['shop=pet'],'tattoo':['shop=tattoo'],'tattoos':['shop=tattoo'],'piercing':['shop=piercing'],'laundry':['shop=laundry'],'dry cleaning':['shop=dry_cleaning'],'tailor':['shop=tailor'],'tailors':['shop=tailor'],'jewelry':['shop=jewelry'],'jeweller':['shop=jewelry'],'jewellers':['shop=jewelry'],'watch':['shop=watches'],'watches':['shop=watches'],'electronics':['shop=electronics'],'phone':['shop=mobile_phone'],'phones':['shop=mobile_phone'],'computer':['shop=computer'],'computers':['shop=computer'],'software':['shop=software','office=software'],'bookstore':['shop=books'],'toy':['shop=toys'],'furniture':['shop=furniture'],'hardware':['shop=hardware'],'paint':['shop=paint'],'garden centre':['shop=garden_centre'],'stationery':['shop=stationery'],'photo':['shop=photo'],'copyshop':['shop=copyshop'],'antiques':['shop=antiques'],'bed':['shop=bed'],'carpet':['shop=carpet'],'lighting':['shop=lighting'],'tiles':['shop=tiles'],'doors':['shop=doors'],'security':['shop=security'],'tool hire':['shop=tool_hire'],'trade':['shop=trade'],'cinema':['amenity=cinema'],'theatre':['amenity=theatre'],'museum':['tourism=museum'],'gallery':['tourism=gallery'],'casino':['amenity=casino'],'nightclub':['amenity=nightclub'],'music venue':['amenity=music_venue'],'arts centre':['amenity=arts_centre'],'library':['amenity=library'],'community centre':['amenity=community_centre'],'conference centre':['amenity=conference_centre'],'events venue':['amenity=events_venue'],'travel agency':['shop=travel_agency'],'taxi':['amenity=taxi'],'bus station':['amenity=bus_station'],'train station':['amenity=train_station'],'ferry terminal':['amenity=ferry_terminal'],'airport':['aeroway=aerodrome'],'school':['amenity=school'],'university':['amenity=university'],'college':['amenity=college'],'kindergarten':['amenity=kindergarten'],'language school':['amenity=language_school'],'music school':['amenity=music_school'],'driving school':['amenity=driving_school'],'surf school':['amenity=surf_school'],'training':['amenity=training'],'research institute':['amenity=research_institute'],'internet cafe':['amenity=internet_cafe'],'gaming':['shop=video_games'],'video games':['shop=video_games'],'camera':['shop=camera'],'drone':['shop=drone'],'flooring':['shop=flooring'],'builder':['craft=builder'],'contractor':['craft=contractor'],'post office':['amenity=post_office'],'police':['amenity=police'],'fire station':['amenity=fire_station'],'townhall':['amenity=townhall'],'courthouse':['amenity=courthouse'],'prison':['amenity=prison'],'marketplace':['amenity=marketplace'],'place of worship':['amenity=place_of_worship'],'funeral hall':['amenity=funeral_hall'],'crematorium':['amenity=crematorium'],'mortuary':['amenity=mortuary'],'convenience':['shop=convenience'],'food court':['amenity=food_court'],'kitchen':['shop=kitchen'],'surf school':['amenity=surf_school']};
    ...
    try{
        ...
        try{
            ...
            if(elements2.length===0){showAlert('Keine Unternehmen gefunden. Bitte andere Nische oder größeren Radius versuchen.','info');setSearching(false);return;}
            processResults(elements2,'osm');
        }catch(err2){
            showAlert('Suche fehlgeschlagen: '+err2.message,'error');
        }
    }finally{
        setSearching(false);
    }
...
function processResults(items,source){
    ...
    if(source==='google'){
        for(const place of items){
            ...
            const lead={
                ...
                category:place.primaryTypeDisplayName?.text||nicheInput.value.trim(),
                status:'tocall',
                notes:'',
                contactDate:'',
                source:'google',
        ...
        for(const el of items){
            ...
            const lead={
                id:id,
                name:tags.name||tags['name:de']||'Unbekannt',
                address:buildAddress(tags),
                phone:tags.phone||tags['contact:phone']||tags.telephone||'',
                website:tags.website||tags['contact:website']||tags['contact:facebook']||tags['contact:instagram']||'',
                mapsUrl:lat&&lon?'https://www.openstreetmap.org/'+el.type+'/'+el.id:'',
                rating:null,
                ratingCount:0,
                category:$('nicheInput').value.trim()||'Unbekannt',
                status:'tocall',
                notes:'',
                contactDate:'',
                source:'osm',
    ...
    addHistory('search',newLeads.length+' neue Leads gefunden ('+source+', '+($('nicheInput').value.trim()||'Unbekannt')+')',locationName);
...
function renderTable(){
    ...
    let html='<table><thead><tr><th class="td-check"><input type="checkbox" id="selectAll" title="Alle auswählen"></th><th>Name</th><th>Adresse</th><th>Telefon</th><th>Webseite</th><th>Bewertung</th><th>Kategorie</th><th>Status</th><th>Notizen</th><th>Kontakt</th><th>Quelle</th><th></th></tr></thead><tbody>';
    let lastBatchId=null;

    for(const lead of filtered){
        if(lastBatchId!==null&&lead.batchId!==lastBatchId){
            html+='<tr class="new-batch-separator"><td colspan="12">Neuer Suchlauf #'+lead.batchId+'</td></tr>';
        }
        lastBatchId=lead.batchId;

        const statusClass='status-'+(lead.status||'tocall');
        const phoneHtml=lead.phone?'<a href="tel:'+escAttr(lead.phone)+'" class="phone-link" target="_self">'+esc(formatPhone(lead.phone))+'</a>':'<span style="color:var(--text-dim)">—</span>';
        const websiteHtml=lead.website?'<a href="'+escAttr(lead.website)+'" class="website-link" target="_blank">Webseite</a>':'<span style="color:var(--text-dim)">—</span>';
        const mapsHtml=lead.mapsUrl?'<a href="'+escAttr(lead.mapsUrl)+'" class="maps-link" target="_blank">&#128506;&#65039;</a>':'<span style="color:var(--text-dim)">—</span>';
        const ratingHtml=lead.rating?'<span class="rating-stars">'+getStars(lead.rating)+'</span><span class="rating-num">'+lead.rating+'</span>':'<span style="color:var(--text-dim)">—</span>';
    ...
    document.querySelectorAll('.note-input').forEach(inp=>{
        inp.addEventListener('change',(e)=>{
            const id=e.target.dataset.id;
            const lead=leads.find(l=>l.id===id);
            if(lead){lead.notes=e.target.value;lead.updatedAt=Date.now();saveData();if(jsonbinKey&&jsonbinId)syncToCloud();}
        });
    });

    document.querySelectorAll('.contact-date').forEach(inp=>{
        inp.addEventListener('change',(e)=>{
            const id=e.target.dataset.id;
            const lead=leads.find(l=>l.id===id);
            if(lead){lead.contactDate=e.target.value;lead.updatedAt=Date.now();saveData();if(jsonbinKey&&jsonbinId)syncToCloud();}
        });
    });
...
function renderDashboard(){
    ...
    const tocall=leads.filter(l=>l.status==='tocall').length;
...
function exportCSV(){
    const filtered=getFilteredLeads();
    if(filtered.length===0){showAlert('Keine Leads zum Exportieren.','warn');return;}
    ...
    const csv=[headers.join(';'),...rows.map(r=>r.map(c=>{const s=String(c).replace(/"/g,'""');return s.includes(';')||s.includes('\n')?'"'+s+'"':s;}).join(';'))].join('\n');
    const blob=new Blob(['\ufeff'+csv],{type:'text/csv;charset=utf-8;'});
    const url=URL.createObjectURL(blob);
    const a=document.createElement('a');
    a.href=url;
    a.download='coldcallfinder-export-'+new Date().toISOString().slice(0,10)+'.csv';
...
function showAlert(msg,type){clearAlert();const div=document.createElement('div');div.className='alert alert-'+type;div.textContent=msg;div.id='activeAlert';const searchSection=$('searchSection');searchSection.parentNode.insertBefore(div,searchSection.nextSibling);setTimeout(clearAlert,8000);}
function clearAlert(){const el=$('activeAlert');if(el)el.remove();}
function setSearching(v){isSearching=v;const btn=$('searchBtn');const txt=$('searchBtnText');if(v){btn.disabled=true;txt.innerHTML='<span class="spinner"></span>Suchen...';}else{btn.disabled=false;txt.textContent='Suchen';}}
function formatPhone(phone){return phone.replace(/\s+/g,' ').trim();}
